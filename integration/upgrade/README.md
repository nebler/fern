...
the semantic schema-8 result, and checks that publication admission receipts,
...
created before migration. It does not make schema 8 readable by older code, and
